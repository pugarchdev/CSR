...
export default function PitchDetailPage() {
  ...
  const handleCallRM = async (e: React.MouseEvent) => {
    const phone = assignedRm?.mobile || assignedRm?.phone || assignedRm?.contactNumber || "+91 98203 34567";
    const refNo = pitch?.pitchReferenceId || params.id;
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2 text-xs pt-1">
                        ...
                        <div className="rounded-xl border border-slate-100 bg-white p-2.5 flex items-center justify-between shadow-2xs">
                          ...
                          <a
                            href={`tel:${(assignedRm.mobile || assignedRm.phone || assignedRm.contactNumber || "+91 98203 34567").replace(/\s/g, "")}`}
                          ...
                          >
                            ...
                            {assignedRm.mobile || assignedRm.phone || assignedRm.contactNumber || "+91 98203 34567"}
                          </a>
                        </div>
                      </div>
                    </div>
