...
const systemNotifications = [
  ...
  { id: "2", title: "New Saffron-accented light UI Rolled Out", content: "MahaCSR has transformed to a light government branding theme complying with Indian Accessibility Guidelines.", type: "update", date: "June 17, 2026", color: "text-[#f97316] bg-[#fff7ed] border-[#ffedd5]" },
