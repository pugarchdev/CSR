---
name: csr-design
description: Design system skill for csr. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# csr Design System

You are building UI for **csr**. Light-themed, neutral palette, sans-serif typography (sans-serif), compact density on a 4px grid, flat elevation (no shadows).
...
![csr Homepage](screenshots/homepage.png)
...
- **Site URL:** `https://www.csr.gov.in/content/csr/global/master/home/home.html`
...
- Creating new components, pages, or visual elements for csr
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "csr" design, style, UI, or theme
