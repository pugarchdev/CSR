...
router.patch("/users/:id/role", requirePermission("user:update"), updateUser);
router.patch("/users/:id/status", requirePermission("user:update"), updateUser);
router.put("/users/:id", requirePermission("user:update"), updateUser);
router.put("/users/:id/role", requirePermission("user:update"), updateUser);
